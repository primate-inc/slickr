  ...
  module Metatags
    ...
    def insert_slickr_meta_tags(inst_var)
      ...
      @slickr_meta_override = {
        ...
        og_image: inst_var.try(:og_image).try(:image_url, :content_800, host: ActionController::Base.asset_host),
        og_url: request.original_url,
        twitter_title: meta_tags.try(:twitter_title),
        twitter_description: meta_tags.try(:twitter_description),
        twitter_image: inst_var.try(:twitter_image).try(:image_url, :content_800, host: ActionController::Base.asset_host)
      }
    end
  end
end
